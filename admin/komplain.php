...
<html lang="en">
  ...
  <script src="<?=$konfig['url']?>/assets/ckeditor/ckeditor.js"></script>
          ...
          <div class="table-responsive">
            <table id="tablee" class="table table-striped table-bordered">
                ...
                ?>
                  ...
                  <td><textarea id="ckeditor" class="ckeditor"><?php if ($row['status'] == 0) { echo'<span class="badge badge-success">Baru</span> '; } ?><?=strftime('%d %B %Y', strtotime($row['tgl_kirim']))?> (<?=waktu($row['tgl_kirim'])?>)</textarea></td>
            		</tr>
            		<?php $no++; }?>
            	</tbody>
            </table>
