		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <a href="<?=$konfig['url']?>/admin/nilai.php" class="btn btn-sm btn-outline-danger">Table Data</a>
          </div>
          ...
          <?php
                            ...
                            <a href="?page=update&id=<?=$pegawai['nik']?>&semester=<?=$_GET['semester']?>&tahun=<?=$_GET['tahun']?>" class="btn btn-info">Update</a>
                            <a href="#" class="btn btn-danger" onclick='deletedata(<?=$pegawai['nik']?>, <?=$ceknilai['semester']?>, <?=$ceknilai['tahun']?>)'>Hapus</a>
                            <hr>
  <print id="areaprint">
    <style type="text/css">
    @media print {
                ...
                <div style="float: right;" align="center">
                  ...
                  Kepala
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>Error</strong> Data Tidak Di Temukan. Ingin Menambahkan Nilai ? <a href="?page=tambah&id=<?=$_GET['nik']?>">Klik Disini</a>
