		<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <a href="<?=$konfig['url']?>/kepala/nilai.php" class="btn btn-sm btn-outline-danger">Table Data</a>
          </div>
  ...
  <print id="areaprint">
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <tr>
                <td>
                    <img src="<?=$konfig['url']?>/assets/img/3.jpg" width="250" height="250" alt="3">
                </td>
                <td class="col-md-9">
