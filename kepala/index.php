        ...
        <div id="slide-out" class="side-nav sn-bg-4 fixed">
            ...
            <li>
                <ul class="collapsible collapsible-accordion">
                  <li><a href="<?=$konfig['url']?>/kepala/index.php" class="collapsible-header waves-effect active"><i class="fa fa-home"></i>Dashboard</a></li>
                    <li><a href="<?=$konfig['url']?>/kepala/nilai.php" class="collapsible-header waves-effect"><i class="fa fa-list"></i>Nilai</a></li>
                </ul>
            </li>
